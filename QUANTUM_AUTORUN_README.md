...
4. **Config file** updated: `quantum/config/quantum_config.yaml` with your workspace details
...
# See: quantum/azure/DEPLOYMENT.md

# Update quantum/config/quantum_config.yaml with your:
# - subscription_id
# - resource_group
# - workspace_name
# - location
