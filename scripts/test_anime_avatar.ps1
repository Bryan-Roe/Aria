...
python .\tools/talk-to-ai\src\chat_cli.py --provider lora --model $modelPath --once "Hello Aria! Tell me about yourself!" 2>$null
...
python .\tools/talk-to-ai\src\chat_cli.py --provider lora --model $modelPath --once "Aria, can you explain what APIs are in simple terms?" 2>$null
Write-Host "`n" -NoNewline
...
python .\tools/talk-to-ai\src\chat_cli.py --provider lora --model $modelPath --once "Aria-chan, I'm feeling discouraged about learning to code. Can you motivate me?" 2>$null
Write-Host "`n" -NoNewline
...
python .\tools/talk-to-ai\src\chat_cli.py --provider lora --model $modelPath --once "Aria, what's your advice for debugging tricky code issues?" 2>$null
...
Write-Host "  • For interactive chat: python .\tools/talk-to-ai\src\chat_cli.py --provider lora --model $modelPath"
