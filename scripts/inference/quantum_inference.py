...
MODEL_PATH = str(_WORKSPACE / "data_out/gguf_training/quantum_demo/model.gguf")
MANIFEST_PATH = str(_WORKSPACE / "data_out/gguf_training/quantum_demo/model_manifest.json")
METRICS_PATH = str(_WORKSPACE / "data_out/gguf_training/quantum_demo/training_metrics.json")
