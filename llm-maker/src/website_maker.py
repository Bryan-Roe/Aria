...
class WebsiteMaker:
    ...
    def create_website(
        ...
        try:
            ...
            messages = [
                {"role": "system", "content": "You are an expert web developer who creates clean, modern, responsive websites."},
    ...
    def update_website(
        ...
        try:
            messages = [
                {"role": "system", "content": "You are an expert web developer who updates websites based on user requirements."},
                {"role": "user", "content": prompt}
            ]
