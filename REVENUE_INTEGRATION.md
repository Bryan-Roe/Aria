...
The main Aria character page (`web/aria_web/index.html`) now includes:
...
### Aria Character Interface (`web/aria_web/index.html`)
...
**Added Hero Button:**
```html
<a href="web/aria_web/index.html" class="button button-primary">👤 Try Aria</a>
```

**Added Platform Section:**
```html
<a href="web/aria_web/index.html" class="page-link">
...
1. **`web/aria_web/index.html`** - Added navigation bar and subscription badge
