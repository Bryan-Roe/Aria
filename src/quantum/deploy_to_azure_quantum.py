...
def main():
    ...
    parser.add_argument('--backend', type=str, default=None, help='Target backend (default: prefer simulator)')
    parser.add_argument('--shots', type=int, default=None, help='Number of shots (default: config value)')
