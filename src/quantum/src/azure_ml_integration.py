...
class QuantumAzureMLDeployment:
    ...
    def connect_workspace(self, subscription_id: str, resource_group: str, 
    ...
    def create_compute_cluster(self, cluster_name: str = "quantum-compute",
                              vm_size: str = "Standard_DS3_v2",
                              min_nodes: int = 0, max_nodes: int = 4) -> ComputeTarget:
        """
    ...
    def submit_training_job(self, script_path: str, experiment_name: str,
    ...
    def register_model(self, model_path: str, model_name: str,
                      description: str = None, tags: Dict[str, str] = None) -> Model:
        """
    ...
    def deploy_inference_endpoint(self, model_name: str, 
                                 service_name: str = "quantum-api",
                                 cpu_cores: int = 2, memory_gb: int = 4) -> Any:
        """
