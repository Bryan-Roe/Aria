...
class EnhancedQuantumClassifier:
    ...
    def __init__(self, n_qubits: int = 8, n_layers: int = 4, config_path: str = None):
        ...
        logger.info(f"Enhanced QuantumClassifier: {self.n_qubits} qubits, {self.n_layers} layers, {self.entanglement} entanglement")
...
class HybridEnhancedClassifier(nn.Module):
    ...
    def __init__(self, input_dim: int, n_qubits: int = 8, n_layers: int = 4, 
