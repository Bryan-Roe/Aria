...
def train_quantum_model(X_train, y_train, X_val, y_val, n_qubits=4, n_layers=2, duration_minutes=45, learning_rate=0.01):
    ...
    while time.time() < end_time:
        ...
        print(f"Epoch {epoch} ({elapsed/60:.1f}min elapsed, {remaining:.1f}min left) - "
