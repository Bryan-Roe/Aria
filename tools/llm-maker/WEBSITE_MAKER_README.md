...
- **File Access**: All sites saved in `tools/llm-maker/generated_sites/`
...
- **Solution**: Check `tools/llm-maker/generated_sites/` directory for your website

## File Structure

Generated websites are saved in:
```
tools/llm-maker/generated_sites/
└── my-website/
    ├── index.html
    ├── about.html
    ├── contact.html
