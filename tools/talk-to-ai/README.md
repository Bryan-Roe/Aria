...
python .\tools/talk-to-ai\src\chat_cli.py --provider agi --once "Explain quantum computing step by step"
...
```powershell
python .\tools/talk-to-ai\src\chat_cli.py --provider agi --once "Move Aria left"
...
python .\tools/talk-to-ai\src\chat_cli.py --provider local --once "Hello there!"
```

Start an interactive chat (local fallback):

```powershell
python .\tools/talk-to-ai\src\chat_cli.py --provider local
```
...
```powershell
python .\tools/talk-to-ai\src\chat_cli.py --provider openai
```
...
```powershell
pip install -r .\tools/talk-to-ai\requirements.txt
```
