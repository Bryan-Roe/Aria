...
- **Impact**: None for quantum-ai training (uses isolated `quantum/venv` with 0.46.0)
...
1. `quantum/scripts/upgrade_qiskit_to_1x.py` (upgrade utility, ~350 lines)
...
2. `quantum/scripts/validate_qiskit_env.py` (extracted detect_conflict function)
...
- **Upgrade Script**: `quantum/scripts/upgrade_qiskit_to_1x.py`
- **Validation Script**: `quantum/scripts/validate_qiskit_env.py`
