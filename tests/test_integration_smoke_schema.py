...
def test_probe_with_local_dev_adapter_allows_slow_ready_endpoint(
    ...
    monkeypatch.setattr(smoke_module.subprocess, "Popen", lambda *args, **kwargs: DummyProc())
    ...
    payload = smoke_module._probe_with_local_dev_adapter("http://localhost:7071/api/ai/status")
