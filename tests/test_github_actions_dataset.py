...
@pytest.mark.slow
def test_dataset_regeneration(tmp_path):
    """Test that dataset can be regenerated successfully without mutating datasets/."""
    temp_output = tmp_path / "github_actions_out"

    # Run the generator with a small number of records for quick test
    # and write to a temp directory to preserve datasets/ immutability.
    ...
    # Verify temp files exist and are valid
    train_file = temp_output / "train.json"
