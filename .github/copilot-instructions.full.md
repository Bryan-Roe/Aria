...
- MCP server entry point: `python quantum/quantum_mcp_server.py` (tools: `create_quantum_circuit`, `simulate_quantum_circuit`, `submit_quantum_job`, `estimate_quantum_cost`).
...
- LoRA readiness: adapter must contain `adapter_config.json` and `adapter_model.safetensors`. Use CLI: `python .\tools/talk-to-ai\src\chat_cli.py --provider lora --model <adapter_dir>`.
...
- MCP server (quantum tools): `python .\quantum-ai\quantum_mcp_server.py`. Tools include `create_quantum_circuit`, `simulate_quantum_circuit`, `submit_quantum_job`, `estimate_quantum_cost` (see `quantum/quantum_mcp_server.py`).
...
python .\tools/talk-to-ai\src\chat_cli.py --provider local --once "Hello"
