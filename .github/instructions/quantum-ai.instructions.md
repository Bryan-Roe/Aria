...
description: "Slim instructions for quantum/"
applyTo: "quantum/**"
---
...
- Interactive Web Dashboard: `quantum/start_dashboard.sh` → http://localhost:5000
- Azure workspace config: `quantum/config/quantum_config.yaml` (requires `az login`).
...
- Key files: `quantum/quantum_mcp_server.py`, `quantum/src/quantum_classifier.py`, `QUANTUM_AUTORUN_README.md`, `quantum/HARDWARE_TEST_RESULTS.md`.
