"""Compatibility shim for chat provider imports.

Loads the canonical implementation from ``ai-projects/chat-cli/src`` and
re-exports its full symbol surface (including private compatibility aliases
used by tests).
"""
