...
class GPUOptimizer:
    ...
    def _print_profile(self, profile: OptimizationProfile):
        ...
        print(f"Precision: {'BF16' if profile.bf16 else 'FP16' if profile.fp16 else '8-bit' if profile.use_8bit else '4-bit' if profile.use_4bit else 'FP32'}")
...
def main():
    ...
    parser.add_argument("--output", type=str, default="data_out/gpu_profile.yaml",
    ...
    profile = optimizer.create_optimization_profile(
        ...
        target_memory_usage=args.memory_usage
    )
