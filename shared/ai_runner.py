...
Environment variables influencing behavior:
  ...
  WRITE_AI_RUN_LOG     -> if '1' (default), write output to tools/talk-to-ai/logs/auto_run_<ts>.txt
...
CHAT_CLI = ROOT_DIR / "tools/talk-to-ai" / "src" / "chat_cli.py"
LOG_DIR = ROOT_DIR / "tools/talk-to-ai" / "logs"
