...
- Per-run charts under `quantum/results/visualizations/`:
...
- Results JSON may be saved to either `quantum/results/` or repo-root `results/` depending on where the test was launched; the visualizer scans both.
