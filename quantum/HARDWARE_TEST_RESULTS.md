...
Generated charts available in `quantum/results/visualizations/`:
...
**Files:**
- Submission script: `quantum/scripts/submit_small_stabilizer.py`
- Results JSON: 
  - `quantum/results/azure_ghz_4q_results_20251101_063833.json` (rigetti)
  - `quantum/results/azure_ghz_6q_results_20251101_064210.json` (rigetti 6q)
  - `quantum/results/azure_ghz_4q_results_20251101_064243.json` (quantinuum)
  - `quantum/results/azure_ghz_4q_results_20251101_064323.json` (quantinuum 100 shots)
- Visualizations: `quantum/results/visualizations/azure_ghz_*.png`
