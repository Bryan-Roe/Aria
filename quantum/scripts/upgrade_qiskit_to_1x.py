...
Usage examples (run from repo root or quantum-ai directory):
    ...
    python quantum/scripts/upgrade_qiskit_to_1x.py --target-version 1.0.2 --ml-version 0.7.0 --install
    python quantum/scripts/upgrade_qiskit_to_1x.py --revert

Post-upgrade validation:
    1. Delete any stale interpreter caches.
    2. Run: quantum/venv/Scripts/python quantum/scripts/validate_qiskit_env.py
    3. Run a smoke test: quantum/venv/Scripts/python quantum/src/quantum_classifier.py
